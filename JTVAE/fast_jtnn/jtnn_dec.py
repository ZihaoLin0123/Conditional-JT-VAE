...
class JTNNDecoder(nn.Module):
    ...
    def __init__(self, vocab, hidden_size, latent_size, cond_lnKD_size, cond_SelectPtoM_size, embedding, dropout_rate_GRU=0.0, dropout_rate_MLP=0.0):
        ...
        self.W = nn.Linear(hidden_size + latent_size + cond_lnKD_size + cond_SelectPtoM_size, hidden_size)  

        #Stop Prediction Weights                                    
        self.U = nn.Linear(hidden_size + latent_size + cond_lnKD_size + cond_SelectPtoM_size, hidden_size)  
